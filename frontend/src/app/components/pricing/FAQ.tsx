...
export default function FAQSection() {
    const faqs = [
        ...
        },
        {
            ...
            a: "GenFrame supports all major formats including PNG, JPG, WEBP, and TIFF. Our AI can output high-resolution files optimized for both digital and print media."
        },
        {
            ...
            <Container maxWidth="md">
                <Box textAlign="center" mb={10}>
                    <Box sx={{
                        ...
                        <QuestionAnswerIcon sx={{ color: 'rgba(3, 105, 161, 1)', fontSize: 28 }} />
                    </Box>
                    <Typography
                        variant="h2"
                        sx={{
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    {faqs.map((faq, i) => (
                        <Accordion
                            ...
                            sx={{
                                ...
                                '&:hover': {
                                    ...
                                    boxShadow: '0 10px 20px -5px rgba(3, 105, 161, 0.1)'
                                },
                        ...
                        >
                            <AccordionSummary
                                expandIcon={<ExpandMoreIcon sx={{ color: 'rgba(3, 105, 161, 1)' }} />}
                                sx={{ px: { xs: 3, md: 4 } }}
                            >
                                <Typography sx={{ fontWeight: 600, color: '#111827', fontSize: '17px' }}>
                                    {faq.q}
                                </Typography>
                            </AccordionSummary>
                ...
                <Box textAlign="center" mt={12}>
                    ...
                    >
                        <Typography sx={{ color: '#111827', fontWeight: 600, mb: 1.5, fontSize: '18px' }}>
                        ...
                        <Button
                            ...
                            sx={{
                                ...
                                color: 'white',
                                boxShadow: '0 10px 20px -5px rgba(3, 105, 161, 0.3)',
                                '&:hover': {
                                    bgcolor: 'rgba(85, 55, 150, 1)',

                                    transform: 'translateY(-1px)',
                                    boxShadow: '0 15px 30px -8px rgba(3, 105, 161, 0.4)'
                                }
                            }}
                        >
                            Contact Support
