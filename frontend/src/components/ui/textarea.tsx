  ...
  return (
    <span
      ...
      className={clsx([
        ...
        'dark:before:hidden',
        // Focus ring
        'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-transparent after:ring-inset after:ring-2 focus-within:after:ring-primary',
        // Disabled state
