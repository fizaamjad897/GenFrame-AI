  ...
  return (
    <Headless.MenuItems
      ...
      className={clsx(
        ...
        "supports-[grid-template-columns:subgrid]:grid supports-[grid-template-columns:subgrid]:grid supports-[grid-template-columns:subgrid]:grid-cols-[auto_minmax(0,1fr)_auto]",
        // Transitions
...
export function DropdownItem({
  ...
  const classes = clsx(
    className,
    // Base styles
    "group cursor-default  px-3.5 py-2.5 focus:outline-hidden sm:px-3 sm:py-1.5 w-full",
    // Text styles
    ...
    // Make the label column shrinkable by using minmax(0,1fr) so text can wrap when needed
    "col-span-full  items-center supports-[grid-template-columns:subgrid]:grid-cols-subgrid",
    // Icons
  ...
  return (
    <Headless.MenuSection
      ...
      className={clsx(
        ...
        "col-span-full supports-[grid-template-columns:subgrid]:grid supports-[grid-template-columns:subgrid]:grid-cols-[auto_minmax(0,1fr)_auto]"
      )}
    />
  );
}
