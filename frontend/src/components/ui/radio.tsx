...
const base = [
  // Basic layout
  "relative isolate flex size-3.5 shrink-0 rounded-full sm:size-3.5",
  ...
  // Border
  "border border-zinc-950/15 group-data-checked:border-(--radio-checked-border) group-data-hover:border-zinc-950/30 group-data-checked:bg-(--radio-checked-border)",
  ...
  // hide the highlight when checked in light mode so the checked color appears uniform
...
const colors = {
  ...
  purple:
    "[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-primary)] [--radio-checked-border:var(--color-primary)]",
  fuchsia:
