...
const base = [
  ...
  // Border
  "border-2 border-gray-200 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-gray-500 group-data-checked:bg-(--checkbox-checked-border)",
  "dark:border-gray-200 dark:group-data-checked:border-transparent dark:group-data-hover:group-data-checked:border-transparent dark:group-data-hover:border-gray-500",
